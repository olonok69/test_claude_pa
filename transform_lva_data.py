...
def main(include_legacy: bool = False) -> None:
    ...
    input_files = {
        ...
        "lvs25_registration": DATA_DIR / "20251104_eventregistration_LVS25.json",
        "lvs24_demographics": DATA_DIR / "20251104_eventregistration_LVS24_demographics.json",
        "lvs25_demographics": DATA_DIR / "20251104_eventregistration_LVS25_demographics.json",
    }

    output_files = {
        "lvs24_registration": DATA_DIR / "20251104_eventregistration_LVS24_graphql.json",
        "lvs25_registration": DATA_DIR / "20251104_eventregistration_LVS25_graphql.json",
        "combined_registration": DATA_DIR / "20251104_eventregistration_LVS24_25_graphql.json",
        "lvs24_demographics": DATA_DIR / "20251104_eventregistration_LVS24_demographics_graphql.json",
        "lvs25_demographics": DATA_DIR / "20251104_eventregistration_LVS25_demographics_graphql.json",
        "combined_demographics": DATA_DIR / "20251104_eventregistration_LVS24_25_demographics_graphql.json",
    }

    legacy_output_files = {
        "lvs24_registration": DATA_DIR / "20251104_eventregistration_LVS24_legacy.json",
        "lvs25_registration": DATA_DIR / "20251104_eventregistration_LVS25_legacy.json",
        "combined_registration": DATA_DIR / "20251104_eventregistration_LVS24_25_legacy.json",
        "lvs24_demographics": DATA_DIR / "20251104_eventregistration_LVS24_demographics_legacy.json",
        "lvs25_demographics": DATA_DIR / "20251104_eventregistration_LVS25_demographics_legacy.json",
        "combined_demographics": DATA_DIR / "20251104_eventregistration_LVS24_25_demographics_legacy.json",
    }
