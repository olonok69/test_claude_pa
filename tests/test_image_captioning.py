...
# Mark all tests in this file as captioner tests
pytestmark = pytest.mark.captioner
...
if platform.system() == "Linux" and IS_TEST == "1" and LOCAL_ENV == "1":
    from image.image_captioning.endpoint_image_captioning import app
...
def test_endpoint_image_captioining():
    """
    Test endpoint image
    """
