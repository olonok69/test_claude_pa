...
class PIIAssessmentService:
    """
    MAP a PII entity to its Category in a specific RISK model GDPR, NIST etc
    """
    ...
    def assess_pii_type(self, detected_pii_type: str) -> RiskAssessment:
        ...
        """
        return self.pii_mapper.map_pii_type(detected_pii_type)
    ...
    def assess_pii_type_list(
        ...
        for pii_type in detected_pii_types:
            ranked_pii.append(self.pii_mapper.map_pii_type(pii_type))
