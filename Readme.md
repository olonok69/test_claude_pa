...
```
┌─────────────────────┐    ┌─────────────────────┐    ┌─────────────────────┐    ┌─────────────────────┐
│   Streamlit Client  │    │   Neo4j Database    │    │   HubSpot CRM       │    │   MSSQL Database    │
│                     │    │                     │    │                     │    │                     │
│  - AI Chat UI       │    │  - Graph Data       │    │  - Contacts         │    │  - SQL Tables       │
│  - Authentication   │◄──►│  - Cypher Queries   │    │  - Companies        │    │  - SQL Queries      │
│  - Multi-Provider   │    │  - Schema Discovery │    │  - Deals & Tickets  │    │  - CRUD Operations  │
│  - Tool Management  │    │  - SSL/HTTPS        │    │                     │    │  - ODBC Connection  │
│  - Conversation     │    └─────────────────────┘    └─────────────────────┘    └─────────────────────┘
│    History          │              ▲                          ▲                          ▲
│  - SSL Support      │              │                          │                          │
└─────────────────────┘              │                          │                          │
           ▲                    ┌────┴─────┐               ┌────┴─────┐               ┌────┴─────┐
           │                    │ Server 4 │               │ Server 5 │               │ Server 3 │
           │                    │ Neo4j    │               │ HubSpot  │               │ MSSQL    │
           │                    │ MCP      │               │ MCP      │               │ MCP      │
