...
const isValidWebpageArgs = (args) => typeof args === 'object' &&
    args !== null &&
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            if (request.params.name === 'search') {
                    ...
                    if (axios.isAxiosError(error)) {
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: `Search API error: ${error.response?.data?.error?.message ?? error.message}`,
                                },
                            ],
                            isError: true,
                        };
                ...
                if (!isValidWebpageArgs(request.params.arguments)) {
                    throw new McpError(ErrorCode.InvalidParams, 'Invalid webpage arguments');
                }
