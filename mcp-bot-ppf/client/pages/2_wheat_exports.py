        ...
        if export_data and projection_metadata:
            ...
            st.session_state.export_data = {
                "Argentina": {
                    ...
                    "2021/2022_pct": 7.3,
                    "2022/2023": 5.5,
                    "2022/2023_change": -9.0,
                    "2023/2024": 12.5,
                    "2023/2024_change": 7.0,
                    "2024/2025": 12.5,
                    "2024/2025_change": 0.0,
                },
                "Australia": {
                    "2021/2022": 27.5,
                    "2021/2022_pct": 13.9,
                    "2022/2023": 31.9,
                    "2022/2023_change": 4.4,
                    "2023/2024": 18.0,
                    "2023/2024_change": -13.9,
                    "2024/2025": 24.0,
                    "2024/2025_change": 6.0,
                },
                "Canada": {
                    "2021/2022": 15.4,
                    "2021/2022_pct": 7.8,
                    "2022/2023": 25.1,
                    "2022/2023_change": 9.7,
                    "2023/2024": 24.0,
                    "2023/2024_change": -1.1,
                    "2024/2025": 24.5,
                ...
                "European Union": {
                    ...
                    "2021/2022_pct": 18.9,
                    "2022/2023": 34.6,
                    "2022/2023_change": -2.9,
                    "2023/2024": 35.0,
                    "2023/2024_change": 0.4,
                    "2024/2025": 30.0,
                    "2024/2025_change": -5.0,
                },
                "Russia": {
                    "2021/2022": 32.1,
                    "2021/2022_pct": 16.2,
                    "2022/2023": 45.5,
                    "2022/2023_change": 13.4,
                    "2023/2024": 51.0,
                    "2023/2024_change": 5.5,
                    "2024/2025": 48.0,
                ...
                "United States": {
                    ...
                    "2021/2022_pct": 11.0,
                    "2022/2023": 21.5,
                    "2022/2023_change": -0.3,
                    "2023/2024": 21.1,
                    "2023/2024_change": -0.4,
                    "2024/2025": 21.8,
                    "2024/2025_change": 0.7,
                },
                "TOTAL MAJOR EXPORTERS": {
                    "2021/2022": 167.8,
                    "2021/2022_pct": 84.6,
                    "2022/2023": 184.1,
                    "2022/2023_change": 16.3,
                    "2023/2024": 182.1,
                    "2023/2024_change": -2.0,
                    "2024/2025": 176.8,
                    "2024/2025_change": -5.3,
                },
            }
...
with tab1:
    ...
    st.markdown(
        f"**Projection Dates**: {st.session_state.export_projection_metadata['last_updated']} | {st.session_state.export_projection_metadata['next_update']}"
    )
    ...
    with col1:
        total_exports = st.session_state.export_data.get(
            "TOTAL MAJOR EXPORTERS", {}
        ).get("2024/2025", 0)
        st.metric("Total Major Exports 2024/2025", f"{total_exports:.1f} Mt")

    with col2:
        total_change = st.session_state.export_data.get(
            "TOTAL MAJOR EXPORTERS", {}
...
with tab2:
    ...
    with st.form("export_projection_form"):
        ...
        for country in st.session_state.export_data.keys():
            ...
            current_change = st.session_state.export_data[country].get(
                "2024/2025_change", 0
            )
        ...
        if st.form_submit_button("Update Export Projections", type="primary"):
            ...
            for country, value in updated_values.items():
                ...
                st.session_state.export_data[country]["2024/2025_change"] = (
            ...
            st.session_state.export_data["TOTAL MAJOR EXPORTERS"][
                "2024/2025"
            ] = total_exports
            st.session_state.export_data["TOTAL MAJOR EXPORTERS"][
                "2024/2025_change"
            ...
            if db:
                db.update_export_value(
                    "TOTAL MAJOR EXPORTERS", "2024/2025", total_exports, total_change
                )
...
with tab3:
    ...
    if countries_to_plot:
        ...
        if st.checkbox("Show Total Major Exporters"):
            total_values = [
                st.session_state.export_data["TOTAL MAJOR EXPORTERS"][year]
                for year in years
            ]
            fig.add_trace(
                go.Scatter(
    ...
    fig_pie.update_layout(
        title="Export Market Share - 2024/2025 Projection", height=500
    )
    ...
    # Change analysis
    create_change_visualization(
        st.session_state.export_data, "Exports", exclude=["TOTAL MAJOR EXPORTERS"]
    )
            ...
            try:
                ...
                if st.button("Import Export Data"):
                    if "wheat_export_data" in uploaded_data:
                        st.session_state.export_data = uploaded_data[
                            "wheat_export_data"
                        ]

                    if "metadata" in uploaded_data:
                        st.session_state.export_projection_metadata = uploaded_data[
                            "metadata"
                        ]
