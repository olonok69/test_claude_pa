...
class CornProductionDB:
    ...
    def get_all_world_demand_data(self):
        """Get all world demand data organized by category and year"""
        conn = self.get_connection()
        cursor = conn.cursor()
        ...
        for category, year, value, pct_total, change, change_pct, unit, status in rows:
    ...
    def update_world_demand_value(
        self, category, year, value, change=None, change_pct=None
    ):
