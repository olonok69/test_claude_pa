...
This will ensure we get fresh data for our agricultural research."""
    ...
    def _create_research_prompt(self) -> str:
        ...
        sites = [
            ...
            "https://www.eurostat.europa.eu",
            "https://apps.fas.usda.gov/PSDOnline/app/index.html#/app/downloads",
            "https://agridata.ec.europa.eu/extensions/DataPortal/cereals.html",
        ]
...
- If sources show percentages for ratios, keep as percentages (very Important for Stock to use Ratio)
...
- To avoid any doubt 2024/2025 means year 2024 and 2025/2026 means year 2025"""
