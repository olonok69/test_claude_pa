...
from pii_codex.utils.configuration import BERT_DEID_CONFIGURATION
...
if __name__ == "__main__":
    ...
    sample = """A private burial ceremony took place in St Petersburg yesterday for the Wagner mercenary boss Yevgeny Prigozhin.
...
Last week, Prigozhin was on a plane which crashed killing all ten people on board. Russian authorities have not said why the plane crashed, but the Kremlin has rejected speculation Putin ordered Prigozhin's death.. Driving License Number 123 456 789 Mr Huertas"""
