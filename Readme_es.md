...
|-----------|----------|-------------|---------------|
| **IA Médica** | Anonimización DICOM | Anonimización de imágenes médicas DICOM usando Microsoft Presidio | [📖 Español](DICOM_FHIR/Readme_es.md) \| [📖 English](DICOM_FHIR/Readme_en.md) |
| **Google AI** | Resumidor de Videos | Transcripción y resumen de videos con IA usando Gemini Pro | [📖 Español](Google_AI/Video_summarizer/Readme_es.md) \| [📖 English](Google_AI/Video_summarizer/Readme.md) |
| **Google AI** | Caché de Contenido | Optimización de caché de contexto de Google AI con API Gemini | [📖 Español](Google_AI/content_caching/Readme_es.md) \| [📖 English](Google_AI/content_caching/Readme_en.md) |
| **OCR Distribuido** | Sistema OCR NATS | Sistema OCR distribuido con mensajería NATS y RapidOCR | [📖 Español](Nats/Readme_es.md) \| [📖 English](Nats/Readme_en.md) |
| **RAG Financiero** | Análisis Financiero | Sistema RAG para análisis financiero fundamental con datos en tiempo real | [📖 Español](RAG/Intro/Readme_es.md) \| [📖 English](RAG/Intro/Readme.md) |
| **Estrategia Trading** | Estrategia Bollinger RSI | Estrategia de trading combinando Bandas de Bollinger y cruce RSI | [📖 Español](RAG/bollinger%20z-score%20rsi%20startegy/Readme_es.md) \| [📖 English](RAG/bollinger%20z-score%20rsi%20startegy/Readme.md) |
| **Análisis Trading** | Z-Score Bollinger | Análisis de trading financiero con Bandas de Bollinger y Z-Score | [📖 Español](RAG/bollinger%20z-score/Readme_es.md) \| [📖 English](RAG/bollinger%20z-score/Readme.md) |
| **Estrategia Trading** | Bollinger Fibonacci | Estrategia avanzada combinando Bandas de Bollinger y retrocesos Fibonacci | [📖 Español](RAG/bollinger-fibonacci_retracements/Readme_es.md) \| [📖 English](RAG/bollinger-fibonacci_retracements/Readme.md) |
| **Estrategia Trading** | Estrategia Connors RSI | Oscilador de momentum avanzado con integración LangGraph para señales mejoradas de reversión a la media | [📖 Español](RAG/connor-rsi/Readme_es.md) \| [📖 English](RAG/connor-rsi/Readme.md) |
| **Estrategia Trading** | MACD Donchian | Estrategia de trading combinada MACD y Canales de Donchian | [📖 Español](RAG/macd_downchain%20startegy/Readme_es.md) \| [📖 English](RAG/macd_downchain%20startegy/Readme.md) |
| **Base de Datos Grafos** | Sistema RAG Neo4j | Interfaz de lenguaje natural para bases de datos grafos Neo4j | [📖 Español](RAG/speak%20with%20your%20Graph%20Database/Readme_es.md) \| [📖 English](RAG/speak%20with%20your%20Graph%20Database/Readme.md) |
| **Integración MCP** | Servidores MCP | Servidores del Protocolo de Contexto de Modelo para integración Claude AI | [📖 Español](mcp/mcp_server/readme_es.md) \| [📖 English](mcp/mcp_server/readme_en.md) |
| **Desarrollo MCP** | Cliente/Servidor Python MCP | Servidor de análisis financiero Python MCP con transporte SSE | [📖 Español](mcp/python_client_server/README_es.md) \| [📖 English](mcp/python_client_server/README.md) |
| **Cliente MCP** | Cliente MCP Multi-Lenguaje | Cliente MCP integral con herramientas de análisis financiero y soporte multi-servidor | [📖 Español](mcp/mcp-client/Readme_es.md) \| [📖 English](mcp/mcp-client/README.md) |
