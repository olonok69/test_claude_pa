...
def build_task_manifest(
    ...
    report_type_suffix = "post_show" if getattr(generator, "report_type", "pre_show") == "post_show" else "pre_show"
    final_report_path = (
        generator.output_dir
        / f"final_report_{generator.event_name.lower()}{generator.event_year}_{report_type_suffix}.md"
    )
    final_entry = {
        "type": "final_report",
        "section": 99,
