...
def create_dataframes(
    ...
    # Initialize variables that might be used later regardless of post_event_process
    list_badgesid_with_seminars_post_event = []
    merged_df_post_event = pd.DataFrame()  # Initialize as empty DataFrame
    ...
    if post_event_process == "yes":
        ...
        # When post_event_process is "no", initialize empty values
        list_badgesid_with_seminars_post_event = []
        merged_df_post_event = pd.DataFrame()  # Empty DataFrame
