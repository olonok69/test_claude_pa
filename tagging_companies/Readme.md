...
A comprehensive full-stack application that provides AI-powered interactions with Google Search and Perplexity AI through Model Context Protocol (MCP) servers. This platform enables seamless web search, AI-powered analysis, and content extraction with optional HTTPS security, user authentication, advanced caching, **company tagging workflows**, and a **CLI tool for batch processing**.
...
4. **Company Classification CLI Tool** - Batch processing tool for large-scale company categorization ⭐ **NEW**
...
| **CLI Tool** | - | Local | Batch processing interface |
...
### **Intelligent Caching System** ⭐ ENHANCED
...
#### **Company Tagging Operations (2 Tools - Embedded stdio MCP Server)** ⭐ NEW
...
#### **Company Tagging MCP Server (2 Tools - Embedded stdio)** ⭐ NEW
...
### **CLI Tool Capabilities** ⭐ NEW
- **Batch Processing**: Process CSV files with hundreds of companies
...
### **Performance Optimization Features** ⭐ ENHANCED
...
#### **Company Tagging in Web Interface** ⭐ NEW
```
...
### [📊 Company Classification CLI Documentation](./readme_cli.md) ⭐ NEW
- Command-line interface for batch processing
- CSV input/output format specifications
- Batch processing utilities and scripts
...
- Track CLI tool performance and batch processing efficiency
...
### **Company Tagging Performance** ⭐ NEW
...
- **CLI Batch Processing**: 5-10 minutes per 50 companies
...
- CLI tool for large-scale batch operations
