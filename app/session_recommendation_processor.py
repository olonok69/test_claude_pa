...
class SessionRecommendationProcessor:
    ...
    def __init__(self, config):
        ...
        """
        self.config = config
        self.output_dir = config.get("output_dir", "data/bva/output")
    ...
    def process(self, create_only_new=True):
        ...
        try:
            ...
            output_file = os.path.join(
                self.output_dir, f"visitor_recommendations_{timestamp}.json"
            )
    ...
    def _load_visitor_data(self):
        ...
        try:
            ...
            visitor_file = os.path.join(
                self.config.get("output_dir", "data/bva/output"), "df_reg_demo_this.csv"
            )
